...
CreaseBrush::CreaseBrush() : Brush()
{

}

CreaseBrush::~CreaseBrush()
{

}

void CreaseBrush::press(const QPoint & mouse)
{
    Brush::press(mouse);

}

void CreaseBrush::drag(const QPoint & mouse)
{
    ...
    for(QPoint & p: _pixels)
    {
        ...
        // sculpt
        Shader * shader = ShaderManager::getInstance()->getShader(Shader::kCreaseBrush);
...
ToolType CreaseBrush::getType()
{
    return ToolType::kCreaseTool;
}
}
