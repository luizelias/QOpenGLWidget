...
InflateBrush::InflateBrush() : Brush()
{
...
void InflateBrush::press(const QPoint & mouse)
{
    Brush::press(mouse);

}

void InflateBrush::drag(const QPoint & mouse)
{
    ...
    for(QPoint & p: _pixels)
    {
        ...
        // sculpt
        Shader * shader = ShaderManager::getInstance()->getShader(Shader::kInflateBrush);
...
ToolType InflateBrush::getType()
{
    return ToolType::kInflateTool;
}
